...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsSearchMenuJsx = __webpack_require__(158);

	var _componentsSearchMenuJsx2 = _interopRequireDefault(_componentsSearchMenuJsx);

	var _componentsSearchDataJsx = __webpack_require__(160);

	var _componentsSearchDataJsx2 = _interopRequireDefault(_componentsSearchDataJsx);
	...
	var SearchForm = (function (_React$Component) {
	  ...
	  function SearchForm() {
	    ...
	    _get(Object.getPrototypeOf(SearchForm.prototype), 'constructor', this).call(this);
	  ...
	  _createClass(SearchForm, [{
	    ...
	    value: function loadComponents() {
	      ...
	      _jquery2['default'].ajax({
	        ...
	        success: function success(appData) {
	          _this.setState({ appData: appData });
	        },
	    ...
	    value: function handleChange(e) {
	      var innerValue = this.refs.innerValue.value.trim();
	    ...
	    key: 'setNewInnerValue',
	    value: function setNewInnerValue(newInnerValue) {
	    ...
	    value: function handleSubmit(e) {
	      ...
	      if (this.state.newObj) {
	        ...
	        (0, _jquery2['default'])('body, html').animate({ scrollTop: window.innerHeight }, 1000);
	      } else {
	        if (this.refs.innerValue.value != 0) {
	          this.state.appData.map(function (appNode) {
	            if (appNode.language.toUpperCase().match(_this2.refs.innerValue.value.toUpperCase())) {
	              _this2.setState({ newObj: appNode, newData: _this2.refs.innerValue.value, dataActive: true });
	              document.getElementsByClassName('section-about')[0].style.display = 'block';
	              (0, _jquery2['default'])('body, html').animate({ scrollTop: window.innerHeight }, 1000);
	            }
	          });
	    ...
	    key: 'passData',
	    value: function passData(newText) {
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                'div',
	                { className: 'entry col-xs-12 text-center' },
	                _react2['default'].createElement(
	                  'div',
	                  { className: 'col-xs-12 col-md-8 col-md-offset-2 text-center hidden-xs' },
	                  _react2['default'].createElement(
	                    'form',
	                    ...
	                    _react2['default'].createElement(
	                      'h2',
	                      { className: 'h2-intro' },
	                      'Programming will bring you to a new world!'
	                    ),
	                    _react2['default'].createElement(
	                      'div',
	                      { className: 'input-group' },
	                      _react2['default'].createElement('input', { type: 'text', ref: 'innerValue', placeholder: 'Start your journey by choosing programming language:', className: 'form-control', onChange: this.handleChange.bind(this) }),
	                      _react2['default'].createElement(
	                        'span',
	                        { className: 'input-group-btn' },
	                        _react2['default'].createElement('input', { type: 'submit', className: 'btn btn-danger', value: 'Travel' })
	                      )
	                    )
	                  ),
	                  _react2['default'].createElement(
	                    'div',
	                    { className: 'searchMenuField' },
	                    _react2['default'].createElement(_componentsSearchMenuJsx2['default'], { active: this.state.active, passData: this.passData, innerValue: this.state.innerValue, setNewInnerValue: this.setNewInnerValue.bind(this) })
	                  )
	                )
	              )
	            ),
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_componentsSearchDataJsx2['default'], { dataActive: this.state.dataActive, newObj: this.state.newObj })
	              )
	            )
	          )
	        )
	...
	_reactDom2['default'].render(_react2['default'].createElement(SearchForm, null), document.getElementsByClassName('entry')[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchMenu = (function (_React$Component) {
		...
		function SearchMenu() {
			...
			_get(Object.getPrototypeOf(SearchMenu.prototype), 'constructor', this).call(this);
			this.state = { data: [] };
		}
		...
		_createClass(SearchMenu, [{
			...
			key: 'handleClick',
			value: function handleClick(node, e) {
				{
				...
				if (this.props.active) {
					return React.createElement(
						...
						this.state.data.map(function (node) {
							if (node.language.toUpperCase().match(_this2.props.innerValue.toUpperCase())) {
								return React.createElement(
									'li',
									{ key: node.id, value: node.lanuage, onClick: _this2.handleClick.bind(_this2, node) },
									React.createElement(
										'a',
										null,
										node.language
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchData = (function (_React$Component) {
	  _inherits(SearchData, _React$Component);

	  function SearchData() {
	    _classCallCheck(this, SearchData);

	    _get(Object.getPrototypeOf(SearchData.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(SearchData, [{
	    key: 'render',
	    value: function render() {
	      if (this.props.dataActive) {
	        return React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'a',
	              { href: this.props.newObj.fullLink },
	              this.props.newObj.link
	            )
	          )
	        );
	      } else {
